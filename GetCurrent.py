...
prep = datetime.datetime.now() - datetime.timedelta(days=1)
prep = prep.strftime("%Y-%m-%d")

url = f'https://api.weatherbit.io/v2.0/history/hourly?&city=Hanoi&country=VN&start_date={prep}&&end_date={next}&key=f7f4fb4d3ad146e4862e400a8038631b'
